...
public sealed class MavParamToggleButtonGroupPropertyViewModel
        ...
        ISupportRefresh
{
    ...
    public const string TypeId = MavParamWidgetIds.ToggleButtonGroup;

    public MavParamToggleButtonGroupPropertyViewModel(IMavParamContext context)
