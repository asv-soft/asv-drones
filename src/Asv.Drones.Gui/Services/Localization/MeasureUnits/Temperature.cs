...
public class Temperature : MeasureUnitBase<double, TemperatureUnits>
{
    private static readonly IMeasureUnitItem<double, TemperatureUnits>[] _units =
    {
        ...
        new DoubleMeasureUnitItem<TemperatureUnits>(TemperatureUnits.Kelvin, RS.Temperature_Kelvin_Title, "K", true,
            "F1", 1),
    };
...
public class TemperatureCelsius : IMeasureUnitItem<double, TemperatureUnits>
{
    ...
    public double Parse(string? value)
    {
        ...
        return double.TryParse(value.Replace(",", "."), NumberStyles.Any, CultureInfo.InvariantCulture, out var v)
            ? v
            : double.NaN;
    }
...
public class TemperatureFarenheit : IMeasureUnitItem<double, TemperatureUnits>
{
    ...
    public string? GetErrorMessage(string? value)
    {
        ...
        value = value.Replace(',', '.');
        return double.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out var v) == false
            ? RS.TemperatureFarenheit_ErrorMessage_NaN
            : default;
    }
