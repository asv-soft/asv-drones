...
public class GpsUavRttViewModel : UavRttItem
{
    ...
    public GpsUavRttViewModel(IVehicleClient vehicle, IRxValue<GpsInfo> gpsInfo) : base(vehicle, "gps")
    {
        IsVisible = false;
    ...
    [Reactive] public GpsFixType FixType { get; set; }
    [Reactive] public DopStatusEnum DopStatus { get; set; }
    [Reactive] public string FixTypeText { get; set; } = RS.UavRttItem_ValueNotAvailable;
    [Reactive] public string ToolTipText { get; set; }
    [Reactive] public string TopStatusText { get; set; }
    [Reactive] public string BottomStatusText { get; set; }
}