...
public class PlaningMissionPointViewModel : ViewModelBaseWithValidation
{
        ...
        : this($"{UriString}.{point.Index}.{point.Type}")
    {
        ...
        Delete = ReactiveCommand.Create(() => { parent.RemovePoint(this); }).DisposeItWith(Disposable);
    ...
    [Reactive] public MavCmd Type { get; set; }
    [Reactive] public bool IsChanged { get; set; }
    [Reactive] public PlaningMissionAnchor MissionAnchor { get; set; }
    [Reactive] public MaterialIconKind Icon { get; set; }
    [Reactive] public string Param1Title { get; set; } = RS.PlaningMissionPointViewModel_Param1Title;
    [Reactive] public string Param2Title { get; set; } = RS.PlaningMissionPointViewModel_Param2Title;
    [Reactive] public string Param3Title { get; set; } = RS.PlaningMissionPointViewModel_Param3Title;
    [Reactive] public string Param4Title { get; set; } = RS.PlaningMissionPointViewModel_Param4Title;
