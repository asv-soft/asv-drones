...
public class HierarchicalStoreEntryViewModel:DisposableReactiveObject
{
    public HierarchicalStoreEntryViewModel()
    {
        ...
        BeginMove = ReactiveCommand.Create(() =>
        {
            IsInMoveMode = true;
        }).DisposeItWith(Disposable);
        CancelMove = ReactiveCommand.Create(() =>
        {
            IsInMoveMode = false;
        }).DisposeItWith(Disposable);
    ...
    [Reactive]
    public bool IsInMoveMode { get; set; }
    [Reactive]
    public bool IsNotInMoveMode { get; set; }
    ...
    [Reactive] 
    public bool IsInEditNameMode { get; set; } = false;
