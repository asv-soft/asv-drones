...
public class DigitIndicator : IndicatorBase
{
    ...
    public static readonly DirectProperty<DigitIndicator, string> TitleProperty = AvaloniaProperty.RegisterDirect<DigitIndicator, string>(
    ...
    public static readonly DirectProperty<DigitIndicator, string> UnitsProperty = AvaloniaProperty.RegisterDirect<DigitIndicator, string>(
    ...
    public static readonly DirectProperty<DigitIndicator, double> ValueProperty = AvaloniaProperty.RegisterDirect<DigitIndicator, double>(
    ...
    public static readonly DirectProperty<DigitIndicator, string> FormatStringProperty = AvaloniaProperty.RegisterDirect<DigitIndicator, string>(
