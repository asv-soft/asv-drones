...
public static class LocalizationHelper
{
    ...
    {
        return new MeasureUnitBind<TObject, TProperty>(source, valuePropertyAccessor, setter, stringPropertyAccessor, stringSetter, measureUnit);
    }
        ...
        where TObject : IReactiveObject, IValidatableViewModel
    {
        ...
        public MeasureUnitBind(TObject source,
            ...
            IMeasureUnitItem<TProperty> measureUnit)
        {
            _sub1 = source.ValidationRule(stringProperty, measureUnit.IsValid, x => measureUnit.GetErrorMessage(x) ?? string.Empty);
