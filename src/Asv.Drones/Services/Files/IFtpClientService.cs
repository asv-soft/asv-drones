...
/// <summary>
/// Unified API for manipulating with files via FTP and
/// for tracking remote changes.
/// </summary>
public interface IFtpClientService : IDisposable
{
    /// <summary>Gets remote side changed (added/removed/renamed).</summary>
    Observable<Unit> RemoteChanged { get; }

    /// <summary>
    /// Gets <c>true</c> when FTP-operation executes
    /// and <c>false</c> when client is not busy.
    /// </summary>
