...
public class MissionProgressViewModel : RoutableViewModel
{
    ...
    private readonly ReactiveProperty<ushort> _currentIndex = new();
    private readonly ReactiveProperty<ushort> _reachedIndex = new();
