...
public class MavlinkParamReadCommand : MavlinkMicroserviceCommand<IParamsClientEx, StringArg>
{
    ...
    public static ValueTask Execute(IRoutable context, string name, CancellationToken cancel = default)
    {
    ...
    protected override async ValueTask<StringArg?> InternalExecute(IParamsClientEx microservice, StringArg arg, CancellationToken cancel)
    {
