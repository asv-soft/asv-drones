...
/// </summary>
[ExportCommand]
public class BurstDownloadItemCommand : ContextCommand<ITransferFtpEntries, DictArg>
{
    public const string Id = $"{BaseId}.transfer.burst_download";
    ...
    )
    {
        ...
        await context.BurstDownloadItem(source, destination, (byte)prtInt, entryType, cancel);
